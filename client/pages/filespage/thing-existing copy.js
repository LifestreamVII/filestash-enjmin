...
import "./thing.scss";
import { Card, NgIf, Icon, EventEmitter, img_placeholder, Input, EventReceiver } from "../../components/";
                ...
                <ToggleableLink
                    ...
                    <Card
                        ...
                        <ActionButton
                            ...
                            onClickMove={this.onMoveRequest.bind(this)}
                        ...
                        {
                            this.props.folderviewer ? (
                                <button onClick={this.onThingFolderSelect.bind(this)}>SELECT</button>
                            ) : ("") 
                        }
